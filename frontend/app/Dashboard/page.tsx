...
//   const [filteredAddresses1, setFilteredAddresses] = useState<Address1[]>([]);
...
//           }
//         );
//         console.log("API Response data:", addressResponse.data);

//         // Check if the data exists and is an array before using .map()
//         if (addressResponse.data && Array.isArray(addressResponse.data.data)) {
//           setTotalItems(addressResponse.data.totalCount);

//           // Format addresses
//           const formattedAddresses = addressResponse.data.data.map((item: any) => ({
//             id: item.id,
...
//           setAddresses2(addressNotificationCounts);
//           setFilteredAddresses(addressNotificationCounts); // Initialize filteredAddresses
...
//         } else {
//           console.warn(
//             "Address data is not in expected format:",
...
//   // const currentAddresses = addressesToShow1.slice(
//   //   indexOfFirstAddress,
//   //   indexOfLastAddress 
//   // );
...
//   // const totalPages = Math.ceil(addressesToShow1.length / addressesPerPage);


    

//    // Determine addresses to show based on filtering 
//    const addressesToShow =
//    filteredAddresses.length > 0 ? filteredAddresses : addresses2;

//  console.log("Final Addresses to Display:", addressesToShow);
...
//                             className={styles.checkBox}
//                           />
//                           <label className="ms-2">Stop Address</label>
//                         </li>
//                         <li className="dropdown-item pt-2">
//                           <input
//                             type="checkbox"
